 ...
 */
function getPlanetAngle(date, orbitalPeriod) {
 ...
 */
export function getDistanceBetweenEarthAndMars(date) {
 ...
 */
export function getLightDelay(date) {
 ...
 */
export function getLightDelayFromMarsDate(marsDate) {
